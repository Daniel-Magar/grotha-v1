...
const userData = [
  { choice: "A", value: "Bootstrapped" },
  { choice: "B", value: "External Funding Raised" },
];

const Step8 = ({ formData, setFormData, setStep }) => {
  ...
  useEffect(() => {
    console.log(formData.company_business_model);
      ...
      <div className="w-full md:ml-[8rem] lg:ml-[10rem]">
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="flex flex-col ">
            <div className="text-[20px] md:text-[23px] font-semibold ">8.</div>
            <div className="hidden lg:flex p-5  "></div>
          </div>
          <div className="flex flex-col">
            <div>
              <p className="text-[20px] md:text-[23px] font-semibold">
                Funding Details *This question is required. *
              </p>
              <p className="text-[18px] text-[#ACACAC]">
                We have a sweet for bootstrapped startups :)
              </p>
            </div>
            <div className="py-10 ">
              <div className="flex flex-col gap-1 md:gap-5  dd  w-[100%] md:w-[70%] lg:w-[100%] xl:w-[100%]">
