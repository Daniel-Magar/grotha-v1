      ...
      <div className="flex  flex-col justify-center items-start md:flex-row md:flex-wrap md:justify-center md:items-center gap-5   min-h-[80vh]  transition-all w-[85%] fade-in-text ">
        <div className=" flex-1 min-w-[150px]  w-full relative">
          <div className="flex justify-start items-start gap-5 ">
            ...
            <div className="flex  justify-center items-start flex-1 md:hidden gap-2 min-h-[250px] ml-[5.6rem]  mt-[1rem] absolute top-0 left-0 right-0 bottom-0">
              ...
              <div className="flex flex-col flex-1  ">
                <div className="text-[14px] font-semibold">Ranganathan</div>
                <div className="text-[12px] font-semibold text-[#ACACAC] text-sm">
        ...
        <div className=" flex-1 min-w-[150px]  w-full ">
          <div className="flex flex-row-reverse md:flex-col-reverse justify-start items-start gap-5 ">
            ...
            <div className="flex flex-row-reverse justify-start items-start flex-1 md:hidden gap-2 min-h-[250px] mt-5 relative  mr-[6rem]">
              <div className="flex justify-start items-start mt-4">
                <div className="w-[2rem] h-[2px] border rounded bg-white"></div>
                <div className="w-2 h-2 border rounded bg-white mt-[-3px]"></div>
              </div>
              <div className="flex flex-col flex-1 justify-end items-end text-right">
                <div className="text-[14px] font-semibold">Arvind</div>
                <div className="text-[12px] font-semibold text-[#ACACAC] text-sm">
                  We help our clients across the globe to enhance ROI, build
                  customer loyalty and enhance business goals.
                </div>
        ...
        <div className=" flex-1 min-w-[150px]  w-full relative">
          <div className="flex justify-start items-start gap-5 ">
            ...
            <div className="flex  justify-start items-start flex-1 md:hidden gap-2 min-h-[250px] ml-[5.6rem]  mt-[1rem] absolute top-0 left-0 right-0 bottom-0">
              <div className="flex justify-start items-start mt-4">
                <div className="w-[2rem] h-[2px] border rounded bg-white"></div>
                <div className="w-2 h-2 border rounded bg-white mt-[-3px]"></div>
              </div>
              <div className="flex flex-col flex-1  ">
                <div className="text-[14px] font-semibold">Ashima</div>
                <div className="text-[12px] font-semibold text-[#ACACAC] text-sm">
                  We help our clients across the globe to enhance ROI, build
                  customer loyalty and enhance business goals.
                </div>
        ...
        <div className=" flex-1 min-w-[150px]  w-full ">
          <div className="flex flex-row-reverse md:flex-col-reverse justify-start items-start gap-5 ">
            ...
            <div className="flex flex-row-reverse justify-start items-start flex-1 md:hidden gap-2 min-h-[250px] mt-5 relative  mr-[6rem]">
              ...
              <div className="flex flex-col flex-1 justify-end items-end text-right">
                <div className="text-[14px] font-semibold">Kiran</div>
                <div className="text-[12px] font-semibold text-[#ACACAC] text-sm">
                  We help our clients across the globe to enhance ROI, build
                  customer loyalty and enhance business goals.
                </div>
        ...
        <div className=" flex-1 min-w-[150px]  w-full relative">
          <div className="flex justify-start items-start gap-5 ">
            ...
            <div className="flex  justify-start items-start flex-1 md:hidden gap-2 min-h-[250px] ml-[5.6rem]  mt-[3rem] absolute top-0 left-0 right-0 bottom-0">
              <div className="flex justify-start items-start mt-4">
                <div className="w-[2rem] h-[2px] border rounded bg-white"></div>
                <div className="w-2 h-2 border rounded bg-white mt-[-3px]"></div>
              </div>
              <div className="flex flex-col flex-1  ">
                <div className="text-[14px] font-semibold">Priyangshu</div>
                <div className="text-[12px] font-semibold text-[#ACACAC] text-sm">
                  We help our clients across the globe to enhance ROI, build
                  customer loyalty and enhance business goals.
                </div>
        ...
        <div className=" flex-1 min-w-[150px]  w-full mb-[6rem]">
          <div className="flex flex-row-reverse md:flex-col-reverse justify-start items-start gap-5 ">
            ...
            <div className="flex flex-row-reverse justify-start items-start flex-1 md:hidden gap-2 min-h-[250px] mt-5 relative  mr-[6rem]">
              ...
              <div className="flex flex-col flex-1 justify-end items-end text-right">
                <div className="text-[14px] font-semibold">Keerthana</div>
                <div className="text-[12px] font-semibold text-[#ACACAC] text-sm">
                  We help our clients across the globe to enhance ROI, build
                  customer loyalty and enhance business goals.
                </div>
